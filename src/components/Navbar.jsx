...
function Navbar() {
  ...
  return (
    <AppBar position="relative" sx={{ bgcolor: 'white' }}>
      <Container maxWidth="xl" sx={{ borderBottom: '1px solid black'}}>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            {pages.map((page) => (
              <Button
                ...
                sx={{ my: 2, color: 'black', display: 'block', textTransform: 'none' }} // Cambia el texto a minúsculas
              >
                {page}
              </Button>
            ))}
